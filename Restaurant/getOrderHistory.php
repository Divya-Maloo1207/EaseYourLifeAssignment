...
<?php
 ...
 $getOrder = 'C';
 $sqlQuery = "SELECT * FROM `tblprocessflow` WHERE `ProcessFlag`='".mysql_real_escape_string($getOrder)."'";
 ...
 while($row = mysqli_fetch_array($result)){
    ...
    echo "<div class='OrderDetails'>
            <b>Order No.".$cart_id."<font style='color: #4CAF50;margin-left:20px;'>Cancelled</font></b><hr>
            <table>
              <tr>
                <th>Item Name</th>
                <th>Quantity</th>
